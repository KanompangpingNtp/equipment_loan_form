...
<div class="container">
    ...
    <table class="table table-bordered table-striped" id="data_table">
        ...
        <tbody class="text-center">
            ...
            <tr>
                @php
                $day = $form->created_at->format('d');
                $month = $thaiMonths[$form->created_at->format('n') - 1];
                $year = $form->created_at->format('Y') + 543; // เพิ่ม 543 เพื่อให้เป็น พ.ศ.
                @endphp
                ...
                <td>
                    <a href="{{ route('adminshowformedit', $form->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i></a>
